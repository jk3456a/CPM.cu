...
struct ModelImpl : Model {
    ...
    ModelImpl(
        ...
        for (int i = 0; i < num_hidden_layers; i++) {
            layers.push_back(new Layer<T>(hidden_size, intermediate_size, num_attention_heads, num_key_value_heads, head_dim, rms_norm_eps, residual_scale, 0, use_qk_norm, use_attn_bias));
        }
